...
"""
protected = ""
for i in range(0, len(jumble)):
    if jumble[i].islower() and jumble[i+1].isupper() and jumble[i+2].isupper() and\
       jumble[i+3].isupper() and jumble[i+4].islower() and jumble[i+5].isupper() and\
       jumble[i+6].isupper() and jumble[i+7].isupper() and jumble[i+8].islower():
        protected += jumble[i+4]
print(protected)